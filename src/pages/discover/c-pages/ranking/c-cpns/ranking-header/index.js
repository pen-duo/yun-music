...
import MHSongOperationBar from '@/components/song-operation-bar';
import {
  RankingHeaderWrapper
} from './style';

export default memo(function MHRankingHeader() {
  // redux
  ...
  return (
    <RankingHeaderWrapper>
      ...
      <div className="info">
        ...
        <MHSongOperationBar favorTitle={`(${topInfo.subscribedCount})`}
